...
const AdminPanel = ({ user }) => {
  ...
  const generateQRCodes = () => {
    ...
    console.table(urls);
    alert(
      'QR URL list generated; check console (table) for model -> QR URL mapping.',
    );
  };
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-indigo-100">Welcome, {user?.email}</span>
              <button
                onClick={handleLogout}
                className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md transition focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-indigo-600"
              >
                Logout
              </button>
            </div>
